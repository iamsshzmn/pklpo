...
from src.features.api import compute_features, create_feature_service
...
class TestGroupRegistryIntegration:
    ...
    def test_registry_has_groups(self):
        ...
        groups = build_registry_snapshot().get_all_names()
    ...
    def test_registry_groups_are_callable(self):
        ...
        for _name, calculator in groups:
    ...
    def test_registry_groups_have_order(self):
        ...
        ordered = build_registry_snapshot().get_ordered()
