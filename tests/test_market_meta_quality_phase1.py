...
from src.market_meta.application.quality_alerts import dispatch_quality_alerts
from src.market_meta.application.quality_checks import check_duplicates_1m
from src.market_meta.application.quality_pipeline import run_quality_pipeline
from src.market_meta.domain.quality import CheckResult, QualityReport, Severity
...
async def test_run_quality_pipeline_persists_and_dispatches(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.market_meta.application.quality_pipeline.run_all_checks",
        run_all_checks_mock,
    )
    ...
    monkeypatch.setattr(
        "src.market_meta.application.quality_pipeline.QualityMetricsRepository",
        _RepoStub,
    )
    ...
    monkeypatch.setattr(
        "src.market_meta.application.quality_pipeline.dispatch_quality_alerts",
        _dispatch,
    )
