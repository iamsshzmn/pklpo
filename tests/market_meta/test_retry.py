...
class TestOKXRetryMechanisms:
    ...
    async def test_rate_limit_enforcement(self):
        ...
        assert end_time - start_time >= 0.9  # Р”РѕР»Р¶РЅР° Р±С‹С‚СЊ Р·Р°РґРµСЂР¶РєР° РѕРєРѕР»Рѕ 1 СЃРµРєСѓРЅРґС‹
    ...
    async def test_exponential_backoff_timing(self, mock_market_class):
        ...
        assert end_time - start_time > 0.1  # Р”РѕР»Р¶РЅР° Р±С‹С‚СЊ РєР°РєР°СЏ-С‚Рѕ Р·Р°РґРµСЂР¶РєР°
