...
class MetricsCollector:
    ...
    def __init__(self):
        ...
        self._current_metrics: FeatureMetrics | None = None
    ...
    def finish_calculation(self) -> FeatureMetrics:
        """Finish tracking and return final metrics."""
        if not self._current_metrics or not self._start_time:
            raise ValueError("No active calculation to finish")

        # Calculate total time
        self._current_metrics.calculation_time_ms = (
        ...
        # Log final metrics
        self._log_final_metrics(self._current_metrics)
...
def finish_calculation_metrics() -> FeatureMetrics:
    """Finish tracking and return final metrics."""
...
def calculate_quality_score(df: pd.DataFrame) -> tuple[float, float, float]:
    ...
    # Filter only numeric columns to avoid errors with string columns
